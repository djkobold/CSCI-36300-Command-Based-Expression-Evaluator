...
public:
  ...
  // COMMENT This method should be remove since it was part of the bad design.
  // RESPONSE The method has been removed
	
private:
  // COMMENT This variable is not necessary since you have the
  // base class.
  // RESPONSE The variable has now been removed and Fixed_Array.cpp has
